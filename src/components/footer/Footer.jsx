    ...
    return (
        <Box px={{xs: 3, sm: 10}} py={{xs: 5, sm: 10}}>
            <Container
                ...
                elevation={5}
            >
                <Grid container justifyContent={'space-around'} alignItems={'center'} sx={{padding: '10px'}}>
                    <Grid item sx={{display: 'flex', alignItems: 'center',gap:'10px'}} xs={12} md={6}>
                        <a href="/">
                            <img src="/assets/logo.png" alt="" className="logo" width='50' height='50'/>
                        </a>
